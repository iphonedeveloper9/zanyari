...
- (void)startSplash {
    ...
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
    {
        ...
        splashImage.frame=CGRectMake(-20, -20, 340, self.frame.size.height+20);
        splashImage.alpha = 0.65;
        UIActivityIndicatorView *av = [[UIActivityIndicatorView alloc]initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleWhiteLarge];
        av.frame=CGRectMake(160, (self.frame.size.height/2)-20, 40, 40);
        av.tag  = 1;
        [av startAnimating];
        [splashImage addSubview:av];
        loadingLabel =	[[UILabel alloc]initWithFrame:CGRectMake(70.0,260.0,200,20)];
        ...
        [splashImage addSubview:loadingLabel];
	}
    else
    {
        splashImage = [[UIImageView alloc] initWithImage:self.image];
        splashImage.frame=CGRectMake(-20, -20, 788, 1044);
        splashImage.alpha = 0.65;
        UIActivityIndicatorView *av = [[UIActivityIndicatorView alloc]initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleWhiteLarge];
        av.frame=CGRectMake((788-80)/2, (1044-80)/2, 80, 80);
        av.tag  = 1;
        [av startAnimating];
        [splashImage addSubview:av];
        loadingLabel =	[[UILabel alloc]initWithFrame:CGRectMake((788-400)/2, (1044+30)/2, 400,40)];
        loadingLabel.text = @"";
